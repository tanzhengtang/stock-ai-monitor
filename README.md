...
| 条件 | 阈值 | 逻辑 |
|:---|:---|:---|
| ① 常规技术通过 | 涨跌幅 ≥ -3% | 大多数正常股票直接通过 |
| ② 价值兜底 | 涨跌幅 ≥ -5% 且 (PE<15 或 ROE>15%) | 小跌但基本面好的不遗漏 |
| ③ 深蹲抄底 | 涨跌幅 ≥ -8% 且 (PE<10 且 ROE>15%) | 大跌但极度低估的进入分析 |
...
| 类别 | 因子 | 满分 | 得分规则 |
|:---|:---|:---:|:---|
| 技术面 | 涨跌幅 | 40 | 温和上涨(2~5%)最高 40，温和涨(0~2%) 35，小跌(-3~0%) 25，中跌(-5~-3%) 15，深跌(-8~-5%) 5 |
| 技术面 | 振幅 | 10 | 振幅>5% +10，振幅>2% +5 |
| 技术面 | 开盘 | 10 | 高开高走 +10 |
| 技术面 | 成交额 | 10 | 成交额>1亿 +10，成交额>3000万 +5 |
| 基本面 | PE | 25 | PE<10: 25，PE<20: 15，PE<40: 5 |
| 基本面 | PB | 15 | PB<1: 15，PB<3: 10，PB<5: 5 |
| 基本面 | ROE | 25 | ROE>20%: 25，ROE>10%: 15，ROE>5%: 5 |
| 基本面 | 利润增长 | 25 | 增长>50%: 25，增长>20%: 15，增长>0%: 5 |
...
| `rsi_reversal` | RSI < 30 → strong_buy | RSI超卖反转，< 40 → buy |
| `macd_signal` | MACD > 0 → buy | MACD金叉 |
| `kdj_signal` | RSV < 20 → buy | KDJ超卖 |
| `bollinger_band` | 跌破下轨 → buy | 布林带支撑 |
| `momentum` | 20日涨幅 > 5% → buy | 动量趋势 |
| `volume_price` | 放量(>1.3x) 且 涨价 → buy | 量价配合 |

**基本面评分（第8策略 `fundamental`）：**

| 因子 | 满分 | 得分规则 |
|:---|:---:|:---|
| PE 市盈率 | 15 | <15: +15，<25: +10，>100: -15 |
| PB 市净率 | 15 | <1: +15，<2: +10，>10: -10 |
| ROE | 15 | >20%: +15，>10%: +10 |
| 利润增长 | 15 | >30%: +15，>10%: +10，<-10%: -10
